...
public class TestAssemblyUtil
{
	...
	public void testAssemblyParse()
	{
		String[] asm = new String[]{
				"# {method} &apos;add&apos; &apos;(JJ)J&apos; in &apos;com/chrisnewland/jitwatch/demo/MakeHotSpotLog&apos;",
				"# this:     rsi:rsi   = &apos;com/chrisnewland/jitwatch/demo/MakeHotSpotLog&apos;",
				"# parm0:    rdx:rdx   = long",
				"# parm1:    rcx:rcx   = long",
				...
				"                                                ; - com.chrisnewland.jitwatch.demo.MakeHotSpotLog::add@-1 (line 144)",
				"0x00007f447590415c: mov    %rdx,%rax",
				"0x00007f447590415f: add    %rcx,%rax          ;*ladd",
				"                                                ; - com.chrisnewland.jitwatch.demo.MakeHotSpotLog::add@2 (line 144)",
